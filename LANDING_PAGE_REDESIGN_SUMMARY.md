...
- **Subheadline**: Clear value prop about 8-15% APY from real market activity
- **Key Stats Bar**: 4 compelling metrics (8-15% APY, 100M fixed supply, 10,000+ nodes, $5-50B attack cost)
...
- **Precise**: Exact numbers (8-15% APY, not "high yields")
