...
const tiers = [
  {
    ...
    description: 'Micro Nodes form the distributed edge of the Noderr network, handling data distribution, telemetry collection, and providing computational power for strategy backtesting. Put your old cell phones or spare computers to use. Install the lightweight app and start earning real rewards.',
    functions: [
      'Cache and distribute blockchain data to peers (decentralized CDN)',
      'Collect anonymized network metrics and market data',
      'Relay transactions across the network',
      'Provide computational power for strategy backtesting (Shadow Data Swarm™)',
    ],
