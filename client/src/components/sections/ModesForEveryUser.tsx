...
const tiers = [
  {
    ...
    description: 'Micro Nodes operate as AI agents in a mesh network, providing compute resources to the Noderr Protocol when overhead capacity is reached. Put your old Androids and iPhones to use. Download our browser extension and start earning real rewards.',
    functions: [
